          ...
          <div className='cart__body' ref={cartBodyRef} onClick={onCloseCart}>
            <div className={`cart__content ${classTransitions}`}>
              ...
              {cartItems.length > 0 ? 
                ...
                ? <CartInfo title='Ваш заказ принят!' image='/react-sneakers/img/order-completed.jpg' text={`Ваш заказ в очереди #${orderNumber}`} completed/> 
                : <CartInfo title='Ваша корзина пуста' image='/react-sneakers/img/cart-empty.png' text='Выберите кроссовки которые вам нравятся'/>}      
